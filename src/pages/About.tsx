  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="bg-gray-100 py-16">
        <div className="container-wide">
          <h2 className="text-3xl font-bold mb-10 text-center">Our Equipment & Facilities</h2>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              ...
              />
              <h3 className="text-2xl font-bold mb-3">State-of-the-Art Equipment</h3>
              <p>
            ...
            <div>
              <img 
                ...
                className="rounded-lg shadow-lg w-full h-auto mb-6" 
              />
              <h3 className="text-2xl font-bold mb-3">4-Acre Facility</h3>
              <p>
