            ...
            <div className="text-center py-20">
              ...
              <p className="text-gray-600 mb-8">
                {searchQuery 
                  ...
                  : 'Check back soon for insights and stories from our workshop.'}
              </p>
            </div>
          ) : (
                ...
                <Card key={post.id} className="overflow-hidden hover:shadow-xl transition-all duration-300 border-0 bg-white shadow-lg hover:transform hover:scale-105">
                  ...
                  <CardContent className="p-6">
                    ...
                    {post.blog_categories && (
                      <Badge variant="secondary" className="mb-3 bg-sawmill-orange/10 text-sawmill-orange border-sawmill-orange/20">
