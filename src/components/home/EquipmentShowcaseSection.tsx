...
const EquipmentShowcaseSection = () => {
  const equipmentFeatures = [
    {
      icon: <Settings className="h-8 w-8 text-sawmill-orange" />,
    ...
    {
      icon: <Truck className="h-8 w-8 text-sawmill-orange" />,
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {equipmentFeatures.map((feature, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <Card className="overflow-hidden hover:shadow-xl transition-all duration-300 border-0 shadow-lg bg-white">
                ...
                <CardContent className="p-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="font-bold text-xl text-sawmill-dark-brown mb-2">
                        {feature.title}
                      </h3>
