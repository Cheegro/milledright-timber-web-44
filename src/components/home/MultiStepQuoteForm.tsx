...
const MultiStepQuoteForm = ({ preSelectedProject }: MultiStepQuoteFormProps) => {
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Textarea 
                          placeholder={getProjectSpecificQuestions(watchedProjectType).placeholder}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Textarea 
                          placeholder="Tell us about your timeline, budget range, or any other important details..."
            ...
            <div className="flex justify-between pt-4">
              ...
              {currentStep < 3 ? (
                <Button 
                  type="button" 
                  onClick={nextStep}
                  className="bg-sawmill-dark-brown hover:bg-sawmill-medium-brown ml-auto"
                  disabled={isSubmitting}
                >
                  Next
