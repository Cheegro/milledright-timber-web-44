  ...
  return <div className="space-y-6 px-4 lg:px-0">
      ...
      <Card className="shadow-2xl border-0 bg-gradient-to-br from-white via-gray-50 to-gray-100 relative overflow-hidden">
        ...
        <CardContent className="space-y-6 p-4 lg:p-8 relative">
          ...
          <Button onClick={addCalculation} variant="outline" className="w-full border-2 border-dashed border-red-400 hover:border-red-600 hover:bg-red-50 font-bold py-4 text-base tracking-wide transform hover:scale-[1.02] transition-all duration-200 lg:text-xl text-stone-600">
