...
const BoardFootCalculator = () => {
  ...
  const generateProfessionalPDF = () => {
    ...
    doc.text('Generated by Board Foot Calculator', pageWidth / 2, currentY, { align: 'center' });
    
    currentY += 8;
    doc.setFontSize(10);
    doc.setTextColor(100, 100, 100);
    doc.text('Powered by MilledRight Sawmill Technology', pageWidth / 2, currentY, { align: 'center' });
    ...
    const disclaimers = [
      '• This document is a CALCULATION RECEIPT, not an invoice or quote',
      '• This tool may be used by any lumber operator or individual',
      '• Calculations are estimates only - verify all measurements independently',
      '• Final pricing may vary based on actual wood selection and market conditions',
      '• Not affiliated with any specific lumber supplier unless otherwise noted'
    ];
    ...
    doc.text(`Reference #: BF-${Date.now().toString().slice(-6)}`, pageWidth - margin, currentY, { align: 'right' });
    ...
    doc.setFontSize(8);
    doc.setTextColor(100, 100, 100);
    doc.text('This calculation tool is provided as-is for estimation purposes only.', pageWidth / 2, currentY, { align: 'center' });
    
    currentY += 8;
    doc.text('Always verify measurements and pricing with your lumber supplier.', pageWidth / 2, currentY, { align: 'center' });
